...
import com.dd2d.gunza.databinding.CommonGroupViewerBinding
import com.dd2d.gunza.study_group.StudyGroup
...
class StudyRoomAdapter(private val isMain: Boolean = false): RecyclerView.Adapter<StudyRoomAdapter.Holder>() {
    ...
    override fun getItemCount() =
        if(isMain) {
            if(studyGroupList.size > 3) { VALUE.CREATE_GROUP_LIMIT }
